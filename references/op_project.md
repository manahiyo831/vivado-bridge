...
sourcing the bridge. If you need them in code, fall through to
`client.exec_tcl(...)`.
...
#   'name':            'project_1',
#   'directory':       'D:/work/project_1',  # absolute path to .xpr's parent dir
#   'part':            'xc7z020clg400-1',
#   'board_part':      None,                # None means no board file is attached
#   'top':             'led_blink',
#   'source_count':    2,                   # files in fileset sources_1
#   'constraint_count':0,                   # files in fileset constrs_1
#   'sim_count':       0,                   # files in sim_1, or None if sim_1 absent
...
- `board_part = None` is meaningful -- it indicates the project has
...
- `sim_count = None` (vs. `0`) distinguishes "no sim_1 fileset
